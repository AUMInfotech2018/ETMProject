package com.example.rakesh.etmproject.utils.network;
...
import com.example.rakesh.etmproject.model.master.HttpTaskCompleteListener;
...
public class HttpConnection {
    ...
    */
    public synchronized void httpGet(final String sUrl, final int timeOutInMilliSecond, final int retries) {
        ...
        ApplicationConstant.getInstance().addToRequestQueue(strReq);
    }
